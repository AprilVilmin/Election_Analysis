...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        # Worked with Josh Decker and got code from https://github.com/PopeScooby/Election_Analysis/blob/main/PyPoll.py
        county_name = row[1]
...
with open(file_to_save, "w") as txt_file:
    ...
    txt_file.write(county_with_largest_turnout_summary)
